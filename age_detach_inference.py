...
from .age_predict_module import Network as mwr_model
...
def inference(data_dir, model_dir, output_dir, args):
    ...
    age_model = mwr_model.create_model(None, 'Global_Regressor')
    age_model.load_state_dict(torch.load('./model/CORAL2020/utk_coral.pth', map_location='cuda'))
    age_model.eval()
